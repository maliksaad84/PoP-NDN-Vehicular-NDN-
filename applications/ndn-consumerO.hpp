...
public:
 ...
 /* // From App
  ...
  virtual void
  WillSendOutIntereststar(uint32_t sequenceNumber);
...
protected:
  ...
  Name m_interestNamestar;     ///< \brief NDN Name of the Interest (use Name)
  Name m_dataName;     ///< \brief NDN Name of the Interest (use Name)
...
public:
 // Name sglobal;
  ...
  int32_t interestReceivedSeqNumber[1000000];
  int32_t dataReceivedSeqNumber[1000000];
  int32_t dataRecommendeddSeqNumber[1000000];
  int32_t recommendedContentRequestedCounter = 0;
  int32_t recommendedContentCounter	=	0;
