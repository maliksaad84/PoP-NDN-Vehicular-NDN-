...
Consumer::StartApplication() // Called at time specified by Start
{
 ...
 // Simulator::Schedule(Seconds(0.4), &Consumer::SendPacket, this);    ///added
  ScheduleNextPacket();            //changed
}
...
Consumer::SendPacket()
{
  ...
  if (seq == std::numeric_limits<uint32_t>::max()) {
    ...
    seq = m_seq++;
/*
    cout<<"*****************SEND INTEREST**********"<<seq<<"   ***TIME***   ";

    ofstream myfile;
      myfile.open ("example.txt", std::ios_base::app);
      myfile << "*****************CONUMER**********"<<seq<<"   ***TIME***   "<<Simulator::Now().ToDouble(Time::S);
    //  myfile.close();
*/
  ...
  //monetNonce[seq]= interest->getNonce();

  //////////////////////////////////////////////////////////////////////////////
    double stim;
    Time now = Simulator::Now();
      stim = now.ToDouble (Time::S);
    ///
    fstream fout;
...
Consumer::OnData(shared_ptr<const Data> data)
{
  ...
  double sti;
        Time now = Simulator::Now();
            sti = now.ToDouble (Time::S);
 //
            NS_LOG_INFO("< DATA for " << seq << data->getName()<<"  successPacketCount ------------------------------------------- = " << successPacket);
    ...
    //      sti = now.ToDouble (Time::S);
        ...
        fstream fout;
            ...
            // opens an existing csv file or creates a new file.
            fout.open("reportondata.csv", ios::out | ios::app);
...
/*
  ofstream myfile;
      myfile.open ("example.txt", std::ios_base::app);
      myfile << "*****************ON DATA**********"<<seq<<"   ***TIME***   "<<Simulator::Now().ToDouble(Time::S);
*/
  ...
  ///////////////////////////////////////////////////////////CSV FORMAT /////////////////////////////////////////////////
    ...
    fstream fo1;
    	          ...
    	          // opens an existing csv file or creates a new file
    	          fo1.open("hopcout.csv", ios::out | ios::app);
